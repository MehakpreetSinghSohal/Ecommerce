...
const Title = styled.p`
  font-size: 1.3rem;   /* Slightly larger for product titles */
  font-weight: 500;
`;
...
const CartItem = styled.div`
  ...
  padding: 12px;
  border-radius: 4px;
   background-color: #fff;  /* Pure white for item background */
...
const PrimaryButton = styled(Button)`
  background-color: #4d1c9c; /* Your primary color */
  color: #fff;

  &:hover {
     background-color: #722ef2;  /* Darker shade on hover */ 
  }
`;
